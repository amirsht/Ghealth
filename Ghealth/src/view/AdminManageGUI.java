...
public class AdminManageGUI extends JFrame {
	...
	public AdminManageGUI() {
		...
		setResizable(false);
		setTitle("G-Health");
		setIconImage(Toolkit.getDefaultToolkit().getImage(AdminManageGUI.class.getResource("/images/logo2.PNG")));
		...
		lblLogo.setIcon(new ImageIcon(AdminManageGUI.class.getResource("/images/logo2.png")));
